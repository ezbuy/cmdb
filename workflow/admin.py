...
class TicketTypeAdmin(admin.ModelAdmin):
    list_display = ('type_name','handler','create_time','modify_time','state')

class TicketTasksAdmin(admin.ModelAdmin):
    list_display = ('tasks_id','title','ticket_type','creator','content','create_time','modify_time','handler','state')
